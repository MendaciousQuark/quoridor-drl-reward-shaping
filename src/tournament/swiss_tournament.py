...
class SwissTournament:
    ...
    def compete(self, num_rounds, num_survivors_per_colour=1):
        for round_number in range(num_rounds):
            ...
            for i, pair in enumerate(pairs):
                ...
                try:
                    result, rounds_played = self.play_game(pair)
                ...
                self.rounds_played[pair[0]] += rounds_played
                self.rounds_played[pair[1]] += rounds_played
            ...
            for index, result in enumerate(results):
                ...
                if not isinstance(result, str):
                    ...
                    self.draws[white] += 1
                    self.draws[black] += 1
                # if(rounds_played < self.max_turns):
                #     pdb.set_trace()
        #pdb.set_trace()
        self.showResults()
    ...
    def play_game(self, pair):
        ...
        self.update_pawns(board, white_competitor, black_competitor, rounds_played)
    ...
    def update_pawns(self, board, white_competitor, black_competitor, rounds_played):
        walls_white = white_competitor.pawns['white'].walls if rounds_played % 2 == 0 else black_competitor.pawns['white'].walls
        walls_black = white_competitor.pawns['black'].walls if rounds_played % 2 == 0 else black_competitor.pawns['black'].walls
        # if(walls_black < 10 or walls_white < 10):
        #     pdb.set_trace()
        ...
        white_competitor.pawns['white'].walls = walls_white
        black_competitor.pawns['white'].walls = walls_white
        white_competitor.pawns['black'].walls = walls_black
        black_competitor.pawns['black'].walls = walls_black
